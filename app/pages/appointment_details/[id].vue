      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p class="text-gray-900">
              {{ getAnimalTypeName(appointment.patient_id.animal) || "-----" }}
            </p>
          </div>
          <div>
            <p class="text-sm font-medium text-gray-500">Wiek</p>
            <p class="text-gray-900">
              {{ appointment.patient_id.animal_age || "-----" }}
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p class="text-sm font-medium text-gray-500">Imię</p>
            <p class="text-gray-900">
              {{ appointment.patient_id.owner.name || "-----" }}
            </p>
          </div>
          <div>
            <p class="text-sm font-medium text-gray-500">Kontakt</p>
            <p class="text-gray-900">
              {{ appointment.patient_id.owner.phone || "-----" }}
            </p>
          </div>
        </div>
      </div>
