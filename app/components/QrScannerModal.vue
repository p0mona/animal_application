<template>
  <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md">
      ...
      <div
        class="border-2 border-dashed border-gray-300 rounded-lg p-4 min-h-64 flex items-center justify-center"
      >
        ...
        <div
          v-if="isValidating"
          class="mt-4 p-3 bg-primary-100 text-primary-700 rounded"
        >
          <div class="flex items-center justify-center">
            <div
              class="animate-spin rounded-full h-4 w-4 border-b-2 border-primary-500 mr-2"
            ></div>
      ...
      <div class="mt-4 flex justify-between">
        <BaseButton label="Przełącz kamerę" @click="switchCamera" />
        <BaseButton label="Anuluj" @click="closeModal" />
      </div>
...
const switchCamera = () => {
  ...
  cameraConstraints.value.facingMode =
    camera.value === "rear" ? "environment" : "user";
  scanError.value = "";
